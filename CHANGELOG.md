...
- **Onboarding failures are routable.** `complete_onboarding` returns `spotify_not_connected` / `teams_not_connected` codes instead of an English sentence the wizard could only print (#978).
