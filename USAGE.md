...
On Linux, the shortcut backend is X11-only: Wayland-native windows do not receive X11 grabs, and a Wayland-native session without a reachable X11/XWayland display reports both configured shortcuts as unavailable instead of claiming they are active.
