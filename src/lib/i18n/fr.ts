...
export const fr: Dict = {
  ...
  'diagnostics.extraProfanityWords': 'Mots grossiers supplémentaires',
  ...
  'diagnostics.respectManualStatus': 'Respecter le statut manuel',
  'diagnostics.gateOutOfOffice': 'Mettre en pause hors du bureau',
  'diagnostics.locale': 'Paramètres régionaux',
  'diagnostics.updateChannel': 'Canal de mise à jour',
  'diagnostics.configSnoozed': 'Synchronisation en pause',
  ...
  'rules.testTitle': 'Tester ces règles',
  'rules.testHint':
    'Saisissez un exemple de piste, choisissez une minute du jour et un jour de la semaine pour voir exactement quelle règle (le cas échéant) se déclencherait.',
  'rules.testArtistLabel': 'Artiste',
  'rules.testTrackLabel': 'Titre',
  'rules.testAlbumLabel': 'Album (facultatif)',
  'rules.testShowLabel': 'Émission / podcast (facultatif)',
  'rules.testDeviceLabel': 'Appareil Spotify (facultatif)',
  'rules.testPlaylistLabel': 'URI de playlist (facultatif)',
  'rules.testDurationLabel': 'Durée (mm:ss, facultatif)',
  'rules.testWeekdayLabel': 'Jour de la semaine',
  'rules.testMinuteLabel': 'Minute du jour (HH:MM)',
  'rules.testRun': 'Lancer le test',
  'rules.testRunning': 'En cours…',
  'rules.testSummaryNoMatch': 'Aucune règle ne correspondrait à cette piste.',
  'rules.testSummaryRuleMatched': 'La règle {index} se déclencherait : {summary}',
  'rules.testStepMatched': 'correspond',
  'rules.testStepNotMatched': 'ne correspond PAS',
  'rules.testStepReason': 'raison : {reason}',
  'rules.testStepDisabled': 'la règle est désactivée',
  'rules.testStepScheduleOutside': 'la plage horaire ne contient pas cette minute',
  'rules.testStepNegated': 'la négation a inversé les conditions',
  'rules.matchKindLabel': 'Style de correspondance',
  'rules.matchKindSubstring': 'Sous-chaîne (par défaut)',
  'rules.matchKindExact': 'Correspondance exacte',
  'rules.matchKindGlob': 'Motif glob',
  'rules.albumSubstringLabel': 'L’album contient…',
  'rules.showSubstringLabel': 'L’émission contient…',
  'rules.deviceSubstringLabel': 'L’appareil contient…',
  'rules.playlistUriLabel': 'L’URI de playlist contient…',
  'rules.minDurationLabel': 'Durée minimale (secondes)',
  'rules.negateLabel': 'Nier (correspond quand les conditions ne sont PAS remplies)',
  'rules.actionLabel': 'Action',
  'rules.actionSuppress': 'Supprimer le statut',
  'rules.actionReplace': 'Remplacer le statut par…',
  'rules.actionSnoozeMinutes': 'Suspendre la sync pendant … minutes',
  'rules.actionProfile': 'Basculer vers le profil…',
  'rules.actionPresence': 'Définir la paire de présence…',
  'rules.actionReplaceStatusPlaceholder': 'Texte du statut',
  'rules.actionSnoozePlaceholder': 'Minutes',
  'rules.actionProfilePlaceholder': 'Nom du profil',
  'rules.actionAvailabilityPlaceholder': 'Disponibilité',
  'rules.actionActivityPlaceholder': 'Activité',
  'dashboard.gateWhyTitle': 'Pourquoi le statut est-il suspendu ?',
  'dashboard.gateWhyShow': 'Afficher pourquoi',
  'dashboard.gateWhyHide': 'Masquer pourquoi',
  'dashboard.gateWhyEmpty': 'Aucun blocage actif — le statut se synchronise normalement.',

  'profiles.sectionTitle': 'Profils de présence',
  'profiles.sectionHint':
    'Enregistrez une superposition nommée (format de statut, barrières, règles) et basculez via la barre, un raccourci ou la CLI.',
  'profiles.empty': 'Aucun profil défini.',
  'profiles.addProfile': 'Ajouter un profil',
  'profiles.removeProfile': 'Supprimer',
  'profiles.activeProfileLabel': 'Profil actif',
  'profiles.activeProfileNone': 'Aucun — utiliser la configuration de base',
  'profiles.overlayStatusFormatLabel': 'Format du statut',
  'profiles.overlayClearOnPauseLabel': 'Effacer le statut en pause',
  'profiles.overlayAvailabilitySyncLabel': 'Synchroniser la disponibilité avec Teams',
  'profiles.overlayGateOutOfOfficeLabel': 'Bloquer sur « Absent du bureau »',
  'profiles.overlayGatePresentingLabel': 'Bloquer sur les applications plein écran',
  'profiles.overlayIdleAwayLabel': 'Arrêter d’annoncer après inactivité (secondes)',
  'profiles.overlayPreferredPresenceLabel': 'Présence préférée',
  'profiles.overlayRulesLabel': 'Sous-ensemble de règles',
  'profiles.overlayRulesHint': 'Remplace la liste de règles de base tant que ce profil est actif.',
  'profiles.overlayNotificationsLabel': 'Notifications',
  'profiles.profileNameLabel': 'Nom du profil',
  'profiles.profileNamePlaceholder': 'p. ex. Focus, Sport',
  'profiles.profileNameDuplicate': 'Un profil portant ce nom existe déjà.',
  'profiles.profileNameTooLong': 'Les noms de profil doivent contenir au plus 32 caractères.',
  'profiles.profileNameMissing': 'Le nom du profil ne peut pas être vide.',
  'profiles.activeProfileUnknown': 'Profil inconnu — la configuration de base reste active.',
  'tray.profilesMenu': 'Profils de présence',
