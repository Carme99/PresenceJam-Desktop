...
export const de: Dict = {
  ...
  'diagnostics.extraProfanityWords': 'Zusätzliche Vulgärwörter',
  ...
  'diagnostics.respectManualStatus': 'Manuellen Status respektieren',
  'diagnostics.gateOutOfOffice': 'Bei Abwesenheit pausieren',
  'diagnostics.locale': 'Gebietsschema',
  'diagnostics.updateChannel': 'Update-Kanal',
  'diagnostics.configSnoozed': 'Synchronisierung pausiert',
  ...
  'dashboard.manualStatusTitle': 'Manueller Status',
  'dashboard.manualStatusPlaceholder': 'Status festlegen, den dein Team eine Weile sehen kann',
  'dashboard.manualStatusExpiryLabel': 'Läuft ab nach',
  'dashboard.manualStatusExpiry15': '15 Minuten',
  'dashboard.manualStatusExpiry30': '30 Minuten',
  'dashboard.manualStatusExpiry60': '1 Stunde',
  'dashboard.manualStatusExpiry120': '2 Stunden',
  'dashboard.manualStatusSet': 'Status festlegen',
  'dashboard.manualStatusClear': 'Status löschen',
  'dashboard.manualStatusActive': 'Aktiv bis {expiry}',
  'dashboard.manualStatusActiveEmpty': 'Aktiv (läuft bald ab)',
  'dashboard.manualStatusRecentTitle': 'Letzte Status',
  'dashboard.manualStatusRecentEmpty': 'Noch keine letzten Status',
  ...
  'rules.testTitle': 'Diese Regeln testen',
  'rules.testHint':
    'Tippe einen Beispieltrack, wähle eine Tagesminute und einen Wochentag — du siehst sofort, welche Regel (falls eine) ausgelöst würde.',
  'rules.testArtistLabel': 'Künstler',
  'rules.testTrackLabel': 'Titel',
  'rules.testAlbumLabel': 'Album (optional)',
  'rules.testShowLabel': 'Sendung / Podcast (optional)',
  'rules.testDeviceLabel': 'Spotify-Gerät (optional)',
  'rules.testPlaylistLabel': 'Playlist-URI (optional)',
  'rules.testDurationLabel': 'Dauer (mm:ss, optional)',
  'rules.testWeekdayLabel': 'Wochentag',
  'rules.testMinuteLabel': 'Tagesminute (HH:MM)',
  'rules.testRun': 'Test ausführen',
  'rules.testRunning': 'Läuft …',
  'rules.testSummaryNoMatch': 'Keine Regel würde auf diesen Track passen.',
  'rules.testSummaryRuleMatched': 'Regel {index} würde auslösen: {summary}',
  'rules.testStepMatched': 'passt',
  'rules.testStepNotMatched': 'passt NICHT',
  'rules.testStepReason': 'Grund: {reason}',
  'rules.testStepDisabled': 'Regel ist deaktiviert',
  'rules.testStepScheduleOutside': 'Zeitfenster enthält diese Tagesminute nicht',
  'rules.testStepNegated': 'Negate hat die Bedingungen umgekehrt',
  'rules.matchKindLabel': 'Vergleichsart',
  'rules.matchKindSubstring': 'Teilzeichenkette (Standard)',
  'rules.matchKindExact': 'Exakte Übereinstimmung',
  'rules.matchKindGlob': 'Glob-Muster',
  'rules.albumSubstringLabel': 'Album enthält …',
  'rules.showSubstringLabel': 'Sendung enthält …',
  'rules.deviceSubstringLabel': 'Gerät enthält …',
  'rules.playlistUriLabel': 'Playlist-URI enthält …',
  'rules.minDurationLabel': 'Mindestdauer (Sekunden)',
  'rules.negateLabel': 'Negate (passt, wenn die Bedingungen NICHT zutreffen)',
  'rules.actionLabel': 'Aktion',
  'rules.actionSuppress': 'Status unterdrücken',
  'rules.actionReplace': 'Status ersetzen durch …',
  'rules.actionSnoozeMinutes': 'Sync pausieren für Minuten …',
  'rules.actionProfile': 'Zu Profil wechseln …',
  'rules.actionPresence': 'Präsenzpaar setzen …',
  'rules.actionReplaceStatusPlaceholder': 'Statustext',
  'rules.actionSnoozePlaceholder': 'Minuten',
  'rules.actionProfilePlaceholder': 'Profilname',
  'rules.actionAvailabilityPlaceholder': 'Verfügbarkeit',
  'rules.actionActivityPlaceholder': 'Aktivität',
  'dashboard.gateWhyTitle': 'Warum ist der Status pausiert?',
  'dashboard.gateWhyShow': 'Warum anzeigen',
  'dashboard.gateWhyHide': 'Warum verbergen',
  'dashboard.gateWhyEmpty': 'Kein aktives Gate — der Status wird normal synchronisiert.',

  'profiles.sectionTitle': 'Präsenzprofile',
  'profiles.sectionHint':
    'Speichere eine benannte Überlagerung (Statusformat, Tore, Regeln) und wechsle sie per Tray, Hotkey oder CLI.',
  'profiles.empty': 'Keine Profile definiert.',
  'profiles.addProfile': 'Profil hinzufügen',
  'profiles.removeProfile': 'Entfernen',
  'profiles.activeProfileLabel': 'Aktives Profil',
  'profiles.activeProfileNone': 'Keines — Basiskonfiguration verwenden',
  'profiles.overlayStatusFormatLabel': 'Statusformat',
  'profiles.overlayClearOnPauseLabel': 'Status bei Pause löschen',
  'profiles.overlayAvailabilitySyncLabel': 'Verfügbarkeit mit Teams synchronisieren',
  'profiles.overlayGateOutOfOfficeLabel': 'Gate bei „Außer Haus“',
  'profiles.overlayGatePresentingLabel': 'Gate bei Vollbild-Apps',
  'profiles.overlayIdleAwayLabel': 'Nach Leerlauf nicht mehr anzeigen (Sekunden)',
  'profiles.overlayPreferredPresenceLabel': 'Bevorzugte Präsenz',
  'profiles.overlayRulesLabel': 'Teilmenge der Regeln',
  'profiles.overlayRulesHint': 'Ersetzt die Basisregelliste, solange dieses Profil aktiv ist.',
  'profiles.overlayNotificationsLabel': 'Benachrichtigungen',
  'profiles.profileNameLabel': 'Profilname',
  'profiles.profileNamePlaceholder': 'z. B. Fokus, Workout',
  'profiles.profileNameDuplicate': 'Ein Profil mit diesem Namen existiert bereits.',
  'profiles.profileNameTooLong': 'Profilnamen dürfen höchstens 32 Zeichen lang sein.',
  'profiles.profileNameMissing': 'Profilname darf nicht leer sein.',
  'profiles.activeProfileUnknown': 'Unbekanntes Profil — Basiskonfiguration bleibt aktiv.',
  'tray.profilesMenu': 'Präsenzprofile',
  'tray.profilesMenuNone': 'Keine Profile definiert',
  'tray.profilesMenuActivateBase': 'Basiskonfiguration verwenden',
  'cli.profileFlag': 'Auf ein benanntes Präsenzprofil wechseln und beenden.',
  'cli.profileActive': 'Aktives Profil ist jetzt „{name}".',
  'cli.profileUnknown': 'Kein Profil namens „{name}" — Basiskonfiguration bleibt aktiv.',
  'settings.shortcutToggleProfile': 'Präsenzprofile wechseln',
